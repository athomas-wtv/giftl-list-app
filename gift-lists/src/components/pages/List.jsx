...
function List(props) {
  ...
  const currentList = props.match.params.id == 1 ? listOne : listTwo;
      ...
      <>
          ...
          <ul>
            {currentList.items.map(item => {
                return <li>Name: {item.name} <Button size="small" variant="contained" color="primary" href={item.url}>View Item</Button></li>
            })}
          </ul>
          <Button size="small" variant="contained" color="primary" href={`/`}>Back</Button>
      </>
  )
}
